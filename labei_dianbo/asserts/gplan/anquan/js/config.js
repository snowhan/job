$c = {
    'p0': '/assets/theme/gplan/anquan/img/',
    'p1':'/assets/theme/gplan/img/',
    'getStarUrl':'/theme_gplan/anquan?save=1',
    'PageUrl':'/theme_gplan/anquan',/*本页URL*/
    'pcode':'ds_zt_aide_0_0_fz',
    'ccode':'zt_aide',
    'OrderUrl':'/order/show' ,    /*订购URL*/
    'PageCode':'theme.gplan.anquan.main'
};
...
//    彩蛋
    'nav_0': {
        path: ['back', 'back', 'btn_footer_5', 'btn_0'],
        img:[$c.p0+'kk2_btn_1.png',$c.p0+'kk2_btn_2.png']
    },
//    领取安全之星按钮
    'btn_0': {
        path: ['back', 'nav_0', 'btn_footer_3', false],
...
//    底排6个按钮
    ...
    'btn_footer_4':{
        path:['nav_0','btn_footer_5',false,'btn_footer_3'],
        img:[$c.p0+$d.resource[4].code+'_f.png',$c.p0+$d.resource[4].code+'_b.png']
    },
    'btn_footer_5':{
        path:['nav_0','btn_footer_0',false,'btn_footer_4'],
