...
$p.starPanel ={
    ...
    'show':function(){
        ...
        $g.show('bg_0');
        $g.show('btn_index');
        $g.id('btn_star_index').src=$c.p0+ 'zhihuiStar.png';
...
$p.initRouter = function () {
    ...
    $c.routes.btn_footer_0.fn = [false,false,function(id,r){$p.gamePanel.show(0);}];
    $c.routes.btn_footer_1.fn = [false,false,function(id,r){$p.gamePanel.show(1);}];
    $c.routes.btn_footer_2.fn = [false,false,function(id,r){$p.gamePanel.show(2);}];
    $c.routes.btn_footer_3.fn = [false,false,function(id,r){$p.gamePanel.show(3);}];
    $c.routes.btn_footer_4.fn = [false,false,function(id,r){$p.gamePanel.show(4);}];
    $c.routes.btn_footer_5.fn = [false,false,function(id,r){$p.gamePanel.show(5);}];
